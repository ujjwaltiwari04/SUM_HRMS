    ...
    if (_canResend) {
      ...
      if (phone.isNotEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            key: const ValueKey('resend_success_snackbar'),
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<PhoneAuthState>(phoneAuthControllerProvider, (previous, next) {
      if (next.errorMessage != null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            key: const ValueKey('otp_error_snackbar'),
    ...
    return Scaffold(
      key: const ValueKey('otp_scaffold'),
      backgroundColor: theme.colorScheme.surface,
      appBar: AppBar(
        key: const ValueKey('otp_app_bar'),
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        key: const ValueKey('otp_icon_container'),
                        width: 80,
                        height: 80,
                    ...
                    Text(
                      ...
                      key: const ValueKey('otp_screen_title'),
                    ...
                    RichText(
                      key: const ValueKey('otp_subtitle_rich_text'),
                      textAlign: TextAlign.center,
                      text: TextSpan(
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            key: const ValueKey('otp_input_field'),
                    ...
                    Center(
                      child: TextButton(
                        key: const ValueKey('change_phone_number_link'),
