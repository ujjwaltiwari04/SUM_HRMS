...
class _LocationHistoryScreenState extends ConsumerState<LocationHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      id: const ValueKey('location_history_scaffold'),
      appBar: AppBar(
        id: const ValueKey('location_history_app_bar'),
                    ...
                    employeesAsync.when(
                      data: (employees) {
                        return DropdownButtonFormField<String>(
                          id: const ValueKey('history_employee_dropdown'),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton.icon(
                          id: const ValueKey('history_date_picker_btn'),
                          onPressed: () async {
                      ...
                      if (_selectedDate != null) ...[
                        ...
                        IconButton(
                          id: const ValueKey('history_clear_date_btn'),
                  ...
                  : historyAsync.when(
                      data: (logs) {
                        ...
                        return ListView.builder(
                          id: const ValueKey('history_logs_list'),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      TextButton.icon(
                                        id: ValueKey('map_action_btn_$index'),
