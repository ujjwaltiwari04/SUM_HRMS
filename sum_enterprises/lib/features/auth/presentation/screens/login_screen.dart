...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<PhoneAuthState>(phoneAuthControllerProvider, (previous, next) {
      if (next.step == PhoneAuthStep.enteringOtp) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            id: const ValueKey('login_error_snackbar'),
    ...
    return Scaffold(
      id: const ValueKey('login_scaffold'),
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        id: const ValueKey('brand_logo_container'),
                        width: 96,
                        height: 96,
                    ...
                    Text(
                      'SUM ENTERPRISES',
                      id: const ValueKey('company_name_title'),
                    ...
                    Text(
                      ...
                      id: const ValueKey('portal_subtitle'),
                      textAlign: TextAlign.center,
                    ...
                    Form(
                      key: _formKey,
                      id: const ValueKey('login_form'),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.stretch,
                        children: [
                          TextFormField(
                            id: const ValueKey('phone_number_field'),
                          ...
                          // Trigger Button
                          CustomButton(
                            id: const ValueKey('continue_button'),
                            text: 'CONTINUE',
                    ...
                    Text(
                      ...
                      id: const ValueKey('compliance_footer'),
                      textAlign: TextAlign.center,
