...
class AttendanceHistoryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      id: const ValueKey('attendance_history_scaffold'),
      body: SafeArea(
        child: Padding(
                ...
                child: historyAsync.when(
                  data: (history) {
                    ...
                    return ListView.separated(
                      id: const ValueKey('history_list_view'),
  ...
  Widget _buildHistoryCard(BuildContext context, ThemeData theme, AttendanceModel record) {
    ...
    return Card(
      id: ValueKey('history_card_${record.attendanceId}'),
      elevation: 0,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    formattedDate,
                    id: ValueKey('history_date_${record.attendanceId}'),
                ...
                Container(
                  id: ValueKey('history_badge_${record.attendanceId}'),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            checkInStr,
                            id: ValueKey('history_check_in_time_${record.attendanceId}'),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            checkOutStr,
                            id: ValueKey('history_check_out_time_${record.attendanceId}'),
                            style: theme.textTheme.bodyMedium?.copyWith(
                              fontWeight: FontWeight.w600,
                            ),
                          ),
            ...
            Row(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      ...
                      id: ValueKey('history_working_hours_${record.attendanceId}'),
                      style: theme.textTheme.bodyMedium?.copyWith(
                        fontWeight: FontWeight.bold,
                        color: theme.colorScheme.primary,
                      ),
                ...
                if (hasLocation)
                  Container(
                    id: ValueKey('location_badge_${record.attendanceId}'),
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Container(
      id: const ValueKey('history_empty_state'),
