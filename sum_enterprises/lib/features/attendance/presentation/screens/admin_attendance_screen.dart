...
class _AdminAttendanceScreenState extends ConsumerState<AdminAttendanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      id: const ValueKey('admin_attendance_scaffold'),
      appBar: AppBar(
        id: const ValueKey('admin_attendance_appbar'),
        title: const Text('Employee Attendance Logs'),
        centerTitle: true,
        actions: [
          if (_selectedDateStr != null || _selectedEmployeeId != null)
            IconButton(
              id: const ValueKey('admin_clear_filters_btn'),
                ...
                children: [
                    ...
                    child: employeesAsync.when(
                      data: (employees) {
                        return DropdownButtonFormField<String>(
                          id: const ValueKey('admin_employee_filter_dropdown'),
                  ...
                  Expanded(
                    ...
                    child: OutlinedButton.icon(
                      id: const ValueKey('admin_date_filter_btn'),
                ...
                child: attendanceLogsAsync.when(
                  data: (logs) {
                    ...
                    return ListView.separated(
                      id: const ValueKey('admin_attendance_list_view'),
  ...
  Widget _buildAttendanceLogTile(BuildContext context, ThemeData theme, AttendanceModel log) {
    ...
    final statusColor = isCheckedIn ? Colors.emerald : Colors.blueGrey;
    final hasLocation = log.checkInLatitude != null && log.checkInLongitude != null;

    return Card(
      id: ValueKey('admin_log_tile_${log.attendanceId}'),
      elevation: 0,
      ...
      child: InkWell(
        id: ValueKey('admin_log_ink_${log.attendanceId}'),
        borderRadius: BorderRadius.circular(14),
        onTap: () {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          log.employeeName,
                          id: ValueKey('admin_log_name_${log.attendanceId}'),
                  ...
                  Container(
                    id: ValueKey('admin_log_badge_${log.attendanceId}'),
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.login_rounded, size: 14, color: Colors.emerald[600]),
                      const SizedBox(width: 4),
                      Text(
                        checkInStr,
                        id: ValueKey('admin_log_in_time_${log.attendanceId}'),
                      ...
                      Text(
                        checkOutStr,
                        id: ValueKey('admin_log_out_time_${log.attendanceId}'),
                        style: theme.textTheme.bodySmall?.copyWith(fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Container(
      id: const ValueKey('admin_attendance_empty_container'),
