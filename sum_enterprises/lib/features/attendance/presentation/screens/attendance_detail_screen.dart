...
class AttendanceDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      id: const ValueKey('attendance_detail_scaffold'),
      appBar: AppBar(
        id: const ValueKey('attendance_detail_appbar'),
        title: const Text('Attendance Details'),
        centerTitle: true,
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          id: const ValueKey('attendance_detail_scroll'),
          ...
          child: Column(
            ...
            children: [
              ...
              Card(
                id: const ValueKey('detail_header_card'),
                elevation: 0,
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ...
                        id: const ValueKey('detail_employee_name'),
                      ...
                      Container(
                        id: const ValueKey('detail_status_badge'),
  ...
  Widget _buildLocationDetailsCard(
    ...
    return Card(
      id: ValueKey('detail_loc_card_${title.replaceAll(' ', '_').toLowerCase()}'),
      elevation: 0,
      shape: RoundedRectangleBorder(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (hasLocation)
              ElevatedButton.icon(
                id: ValueKey('detail_map_btn_${title.replaceAll(' ', '_').toLowerCase()}'),
