...
class _EmployeeDetailsScreenState extends ConsumerState<EmployeeDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      id: ValueKey('employee_details_scaffold_${employee.uid}'),
      appBar: AppBar(
        id: ValueKey('employee_details_app_bar_${employee.uid}'),
        title: const Text('Employee Credentials'),
        centerTitle: true,
        leading: IconButton(
          id: ValueKey('employee_details_back_${employee.uid}'),
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          id: ValueKey('employee_details_scroll_${employee.uid}'),
          ...
          child: Column(
            ...
            children: [
              ...
              Card(
                id: ValueKey('employee_details_header_card_${employee.uid}'),
                elevation: 0,
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      CircleAvatar(
                        id: ValueKey('employee_details_avatar_${employee.uid}'),
                        radius: 44,
                      ...
                      Text(
                        employee.fullName,
                        id: ValueKey('employee_details_name_title_${employee.uid}'),
                      ...
                      Container(
                        id: ValueKey('employee_details_status_indicator_${employee.uid}'),
  ...
  Widget _buildDetailTile(ThemeData theme, String label, String value, IconData icon) {
    return Card(
      id: ValueKey('detail_tile_${label.replaceAll(' ', '_').toLowerCase()}'),
      elevation: 0,
      ...
      child: ListTile(
        ...
        subtitle: Text(
          value,
          id: ValueKey('detail_val_${label.replaceAll(' ', '_').toLowerCase()}'),
  ...
  Widget _buildManagementButton(
    ...
    return Padding(
      ...
      child: OutlinedButton.icon(
        id: ValueKey('admin_manage_btn_$id'),
        onPressed: () {
          context.push(route);
        },
  ...
  Widget _buildLiveLocationCard(BuildContext context, ThemeData theme, String employeeId) {
    ...
    return Card(
      id: const ValueKey('admin_employee_location_card'),
      elevation: 0,
      shape: RoundedRectangleBorder(
            ...
            if (location == null) {
              return Column(
                children: [
                  ...
                  const SizedBox(height: 12),
                  OutlinedButton.icon(
                    id: const ValueKey('refresh_empty_location_btn'),
                  ...
                  children: [
                    Expanded(
                      ...
                      child: FilledButton.icon(
                        id: const ValueKey('view_on_maps_btn'),
                    ...
                    Expanded(
                      flex: 1,
                      child: OutlinedButton.icon(
                        id: const ValueKey('refresh_gps_data_btn'),
                        onPressed: _isRefreshing ? null : _refreshDatabaseMetrics,
                        icon: _isRefreshing
                            ? const SizedBox(
                                width: 14,
