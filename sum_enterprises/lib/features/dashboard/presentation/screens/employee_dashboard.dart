...
class _EmployeeDashboardState extends ConsumerState<EmployeeDashboard> {
  ...
  Widget build(BuildContext context) {
      ...
      if (next.successMessage != null) {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            title: Row(
              children: [
                const Icon(Icons.check_circle_rounded, color: Colors.emerald, size: 28),
    ...
    final List<Widget> tabs = [
      ...
      SingleChildScrollView(
        id: const ValueKey('employee_home_scroll'),
        ...
        child: Column(
          ...
          children: [
            // Header Card
            Card(
              id: const ValueKey('employee_header_card'),
              elevation: 0,
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        // Status Badge
                        Container(
                          id: const ValueKey('employee_status_badge'),
                    ...
                    Text(
                      '${greeting()},',
                      id: const ValueKey('employee_greeting_label'),
                    ...
                    Text(
                      ...
                      id: const ValueKey('employee_display_name'),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          formattedDate,
                          id: const ValueKey('employee_current_date'),
            ...
            Text(
              'QUICK ACTIONS',
              id: const ValueKey('quick_actions_title'),
            ...
            Text(
              'COMPANY NOTICES',
              id: const ValueKey('company_notices_title'),
              style: theme.textTheme.labelMedium?.copyWith(
                fontWeight: FontWeight.bold,
                letterSpacing: 1.5,
                color: theme.colorScheme.primary,
    ...
    return Scaffold(
      id: const ValueKey('employee_dashboard_scaffold'),
      appBar: AppBar(
        id: const ValueKey('employee_app_bar'),
        ...
        actions: _currentIndex == 3
            ...
            : [
                IconButton(
                  id: const ValueKey('employee_app_bar_logout_button'),
      ...
      bottomNavigationBar: NavigationBar(
        id: const ValueKey('employee_bottom_nav_bar'),
        ...
        destinations: const [
          NavigationDestination(
            id: ValueKey('nav_dest_home'),
            icon: Icon(Icons.home_outlined),
            selectedIcon: Icon(Icons.home_rounded),
            label: 'Home',
          ),
          NavigationDestination(
            id: ValueKey('nav_dest_attendance'),
            icon: Icon(Icons.calendar_today_outlined),
            selectedIcon: Icon(Icons.calendar_today_rounded),
            label: 'Attendance',
          ),
          NavigationDestination(
            id: ValueKey('nav_dest_documents'),
            icon: Icon(Icons.folder_open_outlined),
            selectedIcon: Icon(Icons.folder_rounded),
            label: 'Docs',
          ),
          NavigationDestination(
            id: ValueKey('nav_dest_profile'),
  ...
  Widget _buildActionCard(
    ...
    return InkWell(
      id: ValueKey('action_ink_well_$id'),
  ...
  Widget _buildTodayStatusCard(ThemeData theme, AsyncValue<AttendanceModel?> todayAttendanceAsync) {
    return todayAttendanceAsync.when(
      data: (attendance) {
        ...
        return Card(
          id: const ValueKey('today_status_card_real'),
          elevation: 0,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(16),
            side: BorderSide(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      id: const ValueKey('today_status_badge'),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          workingHrsStr,
                          id: const ValueKey('today_working_hours_txt'),
                          style: theme.textTheme.bodyMedium?.copyWith(
                            fontWeight: FontWeight.bold,
                            color: theme.colorScheme.primary,
                          ),
  ...
  Widget _buildTrackingStatusCard(BuildContext context, ThemeData theme, String? employeeId, bool isCheckedIn) {
    ...
    return Card(
      id: const ValueKey('tracking_status_card'),
      elevation: 0,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  id: const ValueKey('tracking_status_badge'),
                  padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                  decoration: BoxDecoration(
                ...
                data: (location) {
                  ...
                  return Column(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  latLongStr,
                                  id: const ValueKey('tracking_lat_long_txt'),
                                  style: theme.textTheme.titleMedium?.copyWith(
                                    fontWeight: FontWeight.bold,
                      ...
                      OutlinedButton.icon(
                        id: const ValueKey('tracking_refresh_btn'),
  ...
  Widget _buildProfileView(ThemeData theme, UserModel? user, bool isLoading) {
    ...
    return SingleChildScrollView(
      id: const ValueKey('profile_scroll_view'),
      ...
      child: Column(
        ...
        children: [
          ...
          Card(
            id: const ValueKey('profile_main_card'),
            elevation: 0,
            shape: RoundedRectangleBorder(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  CircleAvatar(
                    id: const ValueKey('profile_big_avatar'),
                    radius: 48,
                  ...
                  Text(
                    user?.fullName ?? 'Sum Employee',
                    id: const ValueKey('profile_name_title'),
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      id: const ValueKey('profile_designation_badge'),
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: theme.colorScheme.primary,
                        fontWeight: FontWeight.bold,
                      ),
          ...
          Text(
            ...
            id: const ValueKey('credentials_section_title'),
            style: theme.textTheme.labelMedium?.copyWith(
              fontWeight: FontWeight.bold,
              letterSpacing: 1.5,
              color: theme.colorScheme.primary,
          ...
          // Logout facilities
          CustomButton(
            id: const ValueKey('profile_logout_button'),
  ...
  Widget _buildProfileField(ThemeData theme, String label, String value, IconData icon) {
    return Card(
      id: ValueKey('profile_field_${label.replaceAll(' ', '_').toLowerCase()}'),
      elevation: 0,
      ...
      child: ListTile(
        ...
        subtitle: Text(
          value,
          id: ValueKey('profile_val_${label.replaceAll(' ', '_').toLowerCase()}'),
