...
class AdminDashboard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      id: const ValueKey('admin_dashboard_scaffold'),
      appBar: AppBar(
        id: const ValueKey('admin_app_bar'),
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          id: const ValueKey('admin_dashboard_scroll_view'),
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    id: const ValueKey('admin_header_name'),
      ...
      floatingActionButton: FloatingActionButton.extended(
        id: const ValueKey('admin_fab_add_employee'),
        onPressed: () {
  ...
  Widget _buildStatCard(
    ...
    return Card(
      id: ValueKey('admin_stat_card_$id'),
      elevation: 0,
      ...
      child: InkWell(
        id: ValueKey('admin_stat_ink_$id'),
        onTap: onTap,
        borderRadius: BorderRadius.circular(16),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                value,
                id: ValueKey('admin_stat_val_$id'),
                style: theme.textTheme.headlineMedium?.copyWith(
                  fontWeight: FontWeight.bold,
                  color: theme.colorScheme.onSurface,
                ),
  ...
  Widget _buildEmployeeListTile(BuildContext context, ThemeData theme, UserModel employee) {
    return Card(
      id: ValueKey('employee_tile_card_${employee.uid}'),
      elevation: 0,
      color: theme.colorScheme.surface,
      shape: RoundedRectangleBorder(
      ...
      child: InkWell(
        id: ValueKey('employee_tile_ink_well_${employee.uid}'),
        onTap: () {
                  ...
                  builder: (context, ref, child) {
                    ...
                    return Column(
                      ...
                      children: [
                        Text(
                          employee.fullName,
                          id: ValueKey('employee_tile_name_${employee.uid}'),
  ...
  Widget _buildEmptyState(ThemeData theme) {
    return Container(
      id: const ValueKey('admin_empty_state_container'),
  ...
  Widget _buildAdminDrawer(BuildContext context, WidgetRef ref, String adminName) {
    ...
    return Drawer(
      id: const ValueKey('admin_drawer'),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          // Drawer Header
          UserAccountsDrawerHeader(
            id: const ValueKey('admin_drawer_header'),
            decoration: BoxDecoration(
              color: theme.colorScheme.primary,
            ),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ListTile(
                  id: const ValueKey('drawer_item_dashboard'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_employees'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_attendance'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_documents'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_salary'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_leave'),
                ...
                ListTile(
                  id: const ValueKey('drawer_item_settings'),
          ...
          const Divider(),
          ListTile(
            id: const ValueKey('drawer_item_logout'),
